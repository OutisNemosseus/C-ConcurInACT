...
<body>
  ...
  getMonacoLanguage(lang) {
    return {c:'c',cpp:'cpp',shell:'shell',sh:'shell',bash:'shell'}[lang]||'plaintext';
  }
}
...
class CppSourceGenerator extends CSourceGenerator {
  getType() { return 'cppsource'; }
}

class CppHeaderGenerator extends CSourceGenerator {
  getType() { return 'cppheader'; }
}

module.exports = { CSourceGenerator, CHeaderGenerator, ShellGenerator, CppSourceGenerator, CppHeaderGenerator };
