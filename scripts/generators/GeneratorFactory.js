...
const { CSourceGenerator, CHeaderGenerator, ShellGenerator, CppSourceGenerator, CppHeaderGenerator } = require('./CSourceGenerator');
...
class GeneratorFactory {
  ...
  initializeGenerators() {
    const generators = [
      ...
      new CppSourceGenerator(this.config),
      new CppHeaderGenerator(this.config),
    ];
